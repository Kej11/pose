...
num_coords = len(results.post_landmarks.landmark) + len(results.face_landmarks.landmark)
...
with open('coords.csv', mode='w', newline='') as f:
    csv_writer = csv.writier(f,delimiter=',',quotechar='"', quoting=csv.QUOTE_MINIMAL)
